...
#define MyAppName "yanfa7"
#define MyAppVersion GetEnv("APP_VERSION")
#define MyAppPublisher "gulei"
#define MyAppExeName "yanfa7.exe"
#define MyAppURL "E:/desktop/yanfa7-project-simpleLoad"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{E42DB3E1-9248-440B-A3AD-84D0FF458B0E}}
AppName={#MyAppName}
...
SetupIconFile={#MyAppURL}\main_window\static\icon\配置数据处理.ico
Compression=lzma
